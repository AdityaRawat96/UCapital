...
if ($asset_type == "RE") {
    ...
    $editda_margin_min = (array_key_exists('editda_margin_min', $data) && $data['editda_margin_min'] != "") ? $data['editda_margin_min'] : 0;
    $editda_margin_max = (array_key_exists('editda_margin_max', $data) && $data['editda_margin_max'] != "") ? $data['editda_margin_max'] : 0;
