...
if($_SESSION['username'] != '' && $_SESSION['userType'] == '0'){
  ...
  if(mysqli_num_rows($result) > 0 ){
    ...
    if ($con->query($sql)){
      ...
      <html>
      <body>
      <h4>Hi <span style="text-transform:capitalize;"> <B>'.$fName.",".'</B></span><br><br>You have been successfully registered on HomeWide. Please use below credential to sign-in.<br><br>
