...
if($_SESSION['username'] != ''){
  ...
  if($customerID != ''){
    $sql = "INSERT INTO invoice (invoiceID, referenceNumber,	invoiceDate,	paymentDate,	company, employeeID, customerID, customerName,	customerMobile, customerEmail, productID, productCostPrice, productSellingPrice, productQuantity, orderTotal, paymentTotal, paymentAmount, paymentType, paidDate, status)
    VALUES ('$invoiceID', '$referenceNumber', '$invoiceDate', '$paymentDate', '$company', '$employeeID', '$customerID',
      '$customerName', '$customerMobile', '$customerEmail', '$productID', '$productCostPrice', '$productSellingPrice', '$productQuantity', '$orderTotal', '$paymentTotal', '$paymentAmount', '$paymentType', '$paidDate', '$status')";

    }else{
      $sql = "INSERT INTO invoice (invoiceID, referenceNumber,	invoiceDate,	paymentDate,	company, employeeID, customerName,	customerMobile, customerEmail, productID, productCostPrice, productSellingPrice, productQuantity, orderTotal, paymentTotal, paymentAmount, paymentType, paidDate, status)
      VALUES ('$invoiceID', '$referenceNumber', '$invoiceDate', '$paymentDate', '$company', '$employeeID','$customerName', '$customerMobile',
        '$customerEmail', '$productID', '$productCostPrice', '$productSellingPrice', '$productQuantity', '$orderTotal', '$paymentTotal', '$paymentAmount', '$paymentType', '$paidDate', '$status')";
