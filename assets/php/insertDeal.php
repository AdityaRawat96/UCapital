...
if ($asset_type == "Real Estate") {
  ...
  $re_hq_city = array_key_exists('re_hq_city', $data) ? mysqli_real_escape_string($con, trim($data['re_hq_city'])) : "";
  ...
  $investment_amount = (array_key_exists('investment_amount', $data) && $data['investment_amount'] != "") ? $data['investment_amount'] : "";
  $userId = $_SESSION['id'];
  $sql = "INSERT INTO `credit` (`USER_ID`, `DEAL`, `OFFER`, `ASSET_TYPE`, `CREDIT_TYPE`, `BORROWER`, `BORROWER_SUBCAT`, `CURRENCY`, `TYPOLOGY`, `MATURITY_TYPE`,`MATURITY`,`MATURITY_TO`, `PRODUCT_TYPE`, `COLLATERAL_TYPE`, `COUNTRY`, `CITY`, `STATE`, `POSTAL_CODE`, `LIEN_POSITION`, `DESCRIPTION`, `ORIGINAL_AMOUNT`, `ASKING_PRICE`, `MARKET_VALUE`, `JUDICIALIZED`, `BORROWER_DETAILS`, `RATIO_OB`, `RATE`, `DISCOUNTED_RATIO`, `WHO_I_AM`, `AUM`,`NUM_OF_INVESTMENT`, `PREF_INVESTMENT_AMOUNT`,`IMAGE`,`RATIO`,`VALUE_TYPE`,`VALUE_MIN`,`VALUE_MAX`) VALUES ('$userId', '$deal_type', '$offer', '$asset_type', '$credit_type', '$credit_borrower_type', '$credit_borrower_type_category', '$credit_default_currency', '$credit_typology', '$credit_maturity_type'," . ($credit_maturity == '' ? "NULL" : "'" . $credit_maturity . "'") . "," . ($credit_maturity_to == '' ? "NULL" : "'" . $credit_maturity_to . "'") . ", '$credit_product_type', '$credit_collateral_type', '$credit_hq_country', '$credit_hq_city', '$credit_state', '$credit_post_code', '$credit_lien_position', '$credit_description', $credit_original_amount, $credit_asking_price, $credit_market_value, '$credit_judicialized', '$credit_borrower_details', $credit_ratio_ob, $credit_rate, $credit_discounted_ratio, '$credit_who_i_am', $credit_aum, $number_of_investments, '$investment_amount', '$credit_image', '$credit_ratio', '$credit_value', $credit_value_min, $credit_value_max)";
