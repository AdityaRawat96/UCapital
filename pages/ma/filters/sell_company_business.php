<div class="tab-pane" id="Where_company" data-column="location">
  ...
  <div class="form-group mt-1 mb-4" id="whereType">
    <ul class="engery654 subcategories">
      <li class="select_all_filter">All</li>
...
<div class="tab-pane" id="TechnologyOperation_company" data-column="operation_technology">
  <h1>Technology of operation</h1><br>
  <div class="row">
    <div class="col-md-12">
      <input class="all_selector_checkbox_main" type="checkbox" value="All"><span class="category_checkbox_label">All</span><br><br>
      <input type="checkbox" value="Fundraising"><span class="category_checkbox_label">Fundraising</span><br><br>
      <input type="checkbox" value="Sell minority"><span class="category_checkbox_label">Sell minority</span><br><br>
      <input type="checkbox" value="Sell majority"><span class="category_checkbox_label">Sell majority</span><br><br>
      <input type="checkbox" value="Sell totality"><span class="category_checkbox_label">Sell totality</span><br><br>
      <input type="checkbox" value="IPO"><span class="category_checkbox_label">IPO</span><br><br>
      <input type="checkbox" value="Partnership"><span class="category_checkbox_label">Partnership</span><br><br>
      <input type="checkbox" value="Collaboration"><span class="category_checkbox_label">Collaboration</span><br><br>
      <input type="checkbox" value="Joint venture"><span class="category_checkbox_label">Joint venture</span><br><br>
      <input type="checkbox" value="Debt Raising"><span class="category_checkbox_label">Debt Raising</span><br><br>
    </div>
  </div>
</div>
...
<div class="tab-pane" id="Sector_company" data-column="sector">
  ...
  <div class="row">
    <div class="col-12">
      <input class="all_selector_checkbox_main" type="checkbox" value="All"><span class="category_checkbox_label">All</span><br><br>
      <input type="checkbox" value="Information Technology"><span class="category_checkbox_label">Information Technology</span><br><br>
      <input type="checkbox" value="Business Products and Services (B2B)"><span class="category_checkbox_label">Business Products and Services (B2B)</span><br><br>
      <input type="checkbox" value="Healthcare"><span class="category_checkbox_label">Healthcare</span><br><br>
      <input type="checkbox" value="Consumer Products and Services (B2C)"><span class="category_checkbox_label">Consumer Products and Services (B2C)</span><br><br>
      <input type="checkbox" value="Energy"><span class="category_checkbox_label">Energy</span><br><br>
      <input type="checkbox" value="Financial Services"><span class="category_checkbox_label">Financial Services</span><br><br>
      <input type="checkbox" value="Materials and Resources"><span class="category_checkbox_label">Materials and Resources</span><br><br>
    </div>
  </div>
</div>
...
<div class="tab-pane" id="AreaOfActivity_company" data-column="area_of_activity">
  <div class="input-group">
    <input type="text" class="form-control filter_search_query" placeholder="Search..">
    <div class="input-group-btn">
      <button class="btn btn-default" onclick="searchFilter($(this));">
  ...
  <div class="form-group mt-1 mb-4" id="AreaOfActivityType">
    <ul class="engery654 subcategories">
      <li class="select_all_filter">All</li>
      <li class="searchable" data-search="Afghanistan">Afghanistan</li>
      <li class="searchable" data-search="Albania">Albania</li>
...
<div class="tab-pane" id="Employees_company" data-column="num_of_employee">
  <h1>Number of employees</h1><br>
  <div class="row">
    <div class="col-md-12">
      <input class="all_selector_checkbox_main" type="checkbox" value="All"><span class="category_checkbox_label">All</span><br><br>
...
<div class="tab-pane" id="Value_company" data-column="value">
  <h1>Value</h1><br>
  <div class="row">
    <div class="col-md-12">
      <input class="all_selector_checkbox_main" type="checkbox" value="All"><span class="category_checkbox_label">All</span><br><br>
      ...
      <input type="checkbox" value="500000|1000000"><span class="category_checkbox_label">From 500,000 to 1 million</span><br><br>
...
<div class="tab-pane" id="InvestmentRequired_company" data-column="investment_required">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <input type="radio" name="investment_required" value="0|500000"><span class="category_checkbox_label">From 0 to 500,000</span><br><br>
      <input type="radio" name="investment_required" value="500000|1000000"><span class="category_checkbox_label">From 500,000 to 1 million</span><br><br>
...
<div class="tab-pane" id="EbitdaMargin_company" data-column="ebidta_margin">
