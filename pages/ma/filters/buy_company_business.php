...
<div class="tab-pane" id="TechnologyOperation_company" data-column="objective">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <input type="checkbox" value="Buy minority"><span class="category_checkbox_label">Buy minority</span><br><br>
      <input type="checkbox" value="Buy majority"><span class="category_checkbox_label">Buy majority</span><br><br>
      <input type="checkbox" value="Buy totality"><span class="category_checkbox_label">Buy totality</span><br><br>
      ...
      <input type="checkbox" value="Lending"><span class="category_checkbox_label">Lending</span><br><br>
    </div>
  </div>
</div>
