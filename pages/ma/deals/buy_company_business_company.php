<div class="buy_company_business_company hidden_deal_container_main">
  ...
  <div class="row">
    ...
    <div class="col-md-9 col-sm-12 input-container input-group">
      <select class="form-control bc_sector_sel_buy" name="sector">
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-12 input-container input-group-multiple-radio">
      ...
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text">
            <input type="radio" value="fixed" name="preferred_ebitda" class="deal-radio bc_pref_ebitda_buy">
          </span>
        </div>
        <div class="custom-file">
      ...
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text">
            <input type="radio" value="range" name="preferred_ebitda" class="deal-radio bc_pref_ebitda_buy">
          </span>
        </div>
        <div class="custom-file">
          <select class="form-control bc_preferred_ebitda_range_buy" name="preferred_ebitda_range">
  ...
  <div class="row">
    ...
    <div class="col-md-9 col-sm-12 input-container input-group-multiple-checkbox">
      ...
      <input type="checkbox" name="investment_size" class="bc_investment_required_value_buy" value="500000|1000000"> From 500,000 to 1M<br>
      <input type="checkbox" name="investment_size" class="bc_investment_required_value_buy" value="1000000|10000000"> From 1M to 10M<br>
      <input type="checkbox" name="investment_size" class="bc_investment_required_value_buy" value="10000000|1000000000"> More than 10M<br>
    </div>
  </div>
  <div class="row">
    <div class="col-md-3 col-sm-12 deal-heading">
  ...
  <div class="row">
    ...
    <div class="col-md-9 col-sm-12 input-container">
      <div class="input-group">
        <input type="text" class="buy_bc_image-list" hidden value="">
