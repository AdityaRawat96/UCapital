<div class="sell_company_business_company hidden_deal_container_main">
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-md-9 col-sm-12 input-container input-group">
      <select class="industry bc_industry_sel" multiple="multiple" data-placeholder="Select Industries" style="width: 100%;" name="industry" id="industry1">
