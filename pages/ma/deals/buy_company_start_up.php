<div class="buy_company_start_up hidden_deal_container_main">
    ...
    <div class="col-md-9 col-sm-12 input-container input-group">
      <div class="row location_holder">
        <div class="col-md-8 col-sm-12 location_container">
          ...
          <select class="form-control hq_city su_hq_city_buy" name="hq_city">
  ...
  <div class="row">
    ...
    <div class="col-md-9 col-sm-12 input-container input-group">
      <select class="industry su_industry_sel_buy" multiple="multiple" data-placeholder="Select Industries" style="width: 100%;" name="industry" id="su_industry">
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-12 input-container input-group-multiple-radio">
      ...
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text">
            <input type="radio" value="range" name="preferred_ebitda" class="deal-radio su_pref_ebitda_buy">
          </span>
        </div>
        <div class="custom-file">
          <select class="form-control su_preferred_ebitda_range_buy" name="preferred_ebitda_range">
  ...
  <div class="row">
    ...
    <div class="col-md-9 col-sm-12 input-container input-group-multiple-checkbox">
      ...
      <input type="checkbox" name="investment_size" class="su_investment_required_value_buy" value="500000|1000000"> From 500,000 to 1M<br>
      <input type="checkbox" name="investment_size" class="su_investment_required_value_buy" value="1000000|10000000"> From 1M to 10M<br>
      <input type="checkbox" name="investment_size" class="su_investment_required_value_buy" value="10000000|1000000000"> More than 10M<br>
    </div>
  </div>
  <div class="row">
    <div class="col-md-3 col-sm-12 deal-heading">
    ...
    <div class="col-md-9 col-sm-12 input-container input-group">
      <select class="form-control deal_option_visibility_trigger su_who_i_am" name="who_i_am">
  ...
  <div class="option_visibility_target">
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-sm-12 input-container">
        <input type="checkbox" name="investment_size" class="su_investment_amount_buy" value="0|1000000"> Less than 1M<br>
        <input type="checkbox" name="investment_size" class="su_investment_amount_buy" value="1000000|10000000"> From 1M to 10M<br>
        <input type="checkbox" name="investment_size" class="su_investment_amount_buy" value="10000000|50000000"> From 10M to 50M<br>
        <input type="checkbox" name="investment_size" class="su_investment_amount_buy" value="50000000|1000000000"> More than 50M<br>
      </div>
    </div>
  </div>
  <div class="row">
