      ...
      success: function(data) {
        ...
        for (var i = 0; i < obj.length; i++) {
          ...
          if(obj[i].ASSET_TYPE.toLowerCase() == "business company" || obj[i].ASSET_TYPE.toLowerCase() == "start up"){
            ...
            elementData += '" data-id="'+obj[i].ID+'"> <i class="fas fa-bookmark fa-2x"></i> </span> </span> </div><div class="d-flex flex-column justify-content-end p-2"> <span><i> '+obj[i].COUNTRY+", "+obj[i].CITY+' </i></span> <span class="deal-card-heading">'+obj[i].TITLE_1+' <b>'+obj[i].TITLE_2+'</b></span> <div class="listing"> <span><i class="fas fa-chart-pie"></i> &nbsp; Sector: '+obj[i].DETAIL_1+' </span><br><span class="deal-card-subhead"><i class="fas fa-industry"></i> &nbsp;  Industry: '+obj[i].DETAIL_2+'</span><hr> <span ><b>Key Elements:</b> '+obj[i].KEY_ELEMENTS+'</span><br></div></div></div></a> </div>';
            ...
            elementData += '" data-id="'+obj[i].ID+'"> <i class="fas fa-bookmark fa-2x"></i> </span> </span> </div><div class="d-flex flex-column justify-content-end p-2"> <span><i> '+obj[i].COUNTRY+", "+obj[i].CITY+' </i></span> <span class="deal-card-heading">'+obj[i].TITLE_1+' <b>'+obj[i].TITLE_2+'</b></span> <div class="listing"> <span><i class="fas fa-chart-pie"></i> &nbsp; Status: '+obj[i].DETAIL_1+' </span><br><span class="deal-card-subhead"><i class="fas fa-industry"></i> &nbsp;  Surface: '+obj[i].DETAIL_2+' smq</span><hr> <span ><b>Key Elements:</b> '+obj[i].KEY_ELEMENTS+'</span><br></div></div></div></a> </div>';
            $(".itemsList").append(elementData);
            ...
            elementData += '" data-id="'+obj[i].ID+'"> <i class="fas fa-bookmark fa-2x"></i> </span> </span> </div><div class="d-flex flex-column justify-content-end p-2"> <span><i> '+obj[i].COUNTRY+", "+obj[i].CITY+' </i></span> <span class="deal-card-heading">'+obj[i].TITLE_1+' <b>'+obj[i].TITLE_2+'</b></span> <div class="listing"> <span><i class="fas fa-chart-pie"></i> &nbsp; Type: '+obj[i].DETAIL_1+' </span><br><span class="deal-card-subhead"><i class="fas fa-industry"></i> &nbsp;  Market Value: '+obj[i].DETAIL_2+'</span><hr> <span ><b>Key Elements:</b> '+obj[i].KEY_ELEMENTS+'</span><br></div></div></div></a> </div>';
            $(".itemsList").append(elementData);
            ...
            elementData += '" data-id="'+obj[i].ID+'"> <i class="fas fa-bookmark fa-2x"></i> </span> </span> </div><div class="d-flex flex-column justify-content-end p-2"> <span><i> '+obj[i].COUNTRY+", "+obj[i].CITY+' </i></span> <span class="deal-card-heading">'+obj[i].TITLE_1+' <b>'+obj[i].TITLE_2+'</b></span> <div class="listing"> <span><i class="fas fa-chart-pie"></i> &nbsp; Type: '+obj[i].DETAIL_1+' </span><br><span class="deal-card-subhead"><i class="fas fa-industry"></i> &nbsp;  Maturity: '+obj[i].DETAIL_2+'</span><hr> <span ><b>Key Elements:</b> '+obj[i].KEY_ELEMENTS+'</span><br></div></div></div></a> </div>';
            $(".itemsList").append(elementData);
          }
        }
