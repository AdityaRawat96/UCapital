                  ...
                  <div class="card">
                    ...
                    <div class="card-body-investor-details2">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <p class="descr-found-inv-s"> PROFILE </p>
                          <table class="table table-investor-pro6">
                            ...
                            <tr class="profile-investor-heading">
                              ...
                              <td> <?=$row['Primary_Investor_Type']; ?> </td>
                            </tr>
                            <tr class="profile-investor-heading">
                              <td> Other Investor Types </td>
                              <td> <?=$row['Other_Investor_Types']; ?> </td>
                            </tr>
                            <tr class="profile-investor-heading">
                              <td> Preferred Investment Types </td>
                              <td> <?=$row['Preferred_Investment_Types']; ?> </td>
                            </tr>
                            <tr class="profile-investor-heading">
                              <td> Investor Status </td>
                              <td> <?=$row['Investor_Status']; ?> </td>
                            </tr>
                          </table>
                        </div>
                                ...
                                <table class="table">
                                  ...
                                  <tbody class="body-invent7897980-profile">
                                    <tr class="odd">
                                      ...
                                      <td> <?=$row['Preferred_Industry']; ?> </td>
                                    </tr>
                                    <tr class="even">
                                      <td> <b> PRIMARY VERTICALS </b> </td>
                                      <td> <?=$row['Preferred_Verticals']; ?> </td>
                                    </tr>
                                    <tr class="odd">
                                      <td> <b> ACTIVE PORTFOLIO </b> </td>
                                      <td> <?=$row['Active_Portfolio']; ?> </td>
                                    </tr>
                                    <tr class="even">
                                      <td> <b> EXITS </b> </td>
                                      <td> <?=$row['Exits']; ?> </td>
                                ...
                                <table class="table">
                                  ...
                                  <tbody class="body-invent7897980-profile">
                                    ...
                                    <tr class="even">
                                      ...
                                      <td> <?=$row['Other_Stated_Preferences']; ?> </td>
                                    </tr>
                                    <tr class="odd">
                                      <td> <b> PREFERRED INVESTMENT AMOUNT </b> </td>
                                      <td> <?=$row['Preferred_Investment_Amount']; ?> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-md-6 col-sm-12 contact-container">
                                  ...
                                  <span>
                                    ...
                                    <span><?=$row['HQ_City']." ".$row['HQ_Country']; ?></span>
                                  </span><br><br>
                                  <span>
                                    <span class="contact-icon">
                                      <i class="fas fa-envelope"></i> &nbsp;
                                    </span>
                                    <span><?=$row['HQ_Email']; ?></span>
                                  </span><br><br>
                                  <span>
                                    <span class="contact-icon">
                                      <i class="fas fa-phone-alt"></i> &nbsp;
                                    </span>
                                    <span><?=$row['HQ_Phone']; ?></span>
                                  </span>
                                </div>
                                <div class="col-md-6 col-sm-12 contact-container">
                                  ...
                                  <span>
                                    &nbsp; &nbsp; &nbsp;
                                    <span><?=$row['Primary_Contact_Title']; ?></span>
                                  </span><br><br>
                                  <span>
                                    <span class="contact-icon">
                                      <i class="fas fa-envelope"></i> &nbsp;
                                    </span>
                                    <span><?=$row['Primary_Contact_Email']; ?></span>
                                  </span><br><br>
                                  <span>
                                    <span class="contact-icon">
                                      <i class="fas fa-phone-alt"></i> &nbsp;
                                    </span>
                                    <span><?=$row['Primary_Contact_Phone']; ?></span>
                                  </span>
                                </div>
                              </div>
                            </div>
